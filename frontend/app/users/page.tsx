    ...
    <div className="p-6">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          <div className={`${currentTheme.cardBg} rounded-lg shadow-xl max-w-md w-full mx-4`}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input type="text" required value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} 
                    className={`w-full px-3 py-2 border border-gray-300 rounded-lg ${currentTheme.cardBg} ${currentTheme.mainText} focus:outline-none focus:ring-2 focus:ring-blue-500`} 
                  />
                </div>
                <div>
