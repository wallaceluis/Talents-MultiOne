...
export const CandidatesTable = ({ isReadOnly = false }: CandidatesTableProps) => {
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <span
                                    className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${currentTheme.name === 'Claro'
                        ...
                        {CandidatesTableData.map((row) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-4 text-center">
                                    <span
                                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${currentTheme.name === 'Claro'
                                                ? 'bg-green-500/20 text-green-600'
                                                : 'bg-blue-500/20 text-blue-300'
                                            }`}
                                    >
